...
export function StickyRunBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center px-4 pb-safe-or-4 pb-4 pointer-events-none">
      <div className="pointer-events-auto flex items-center gap-3 rounded-2xl border theme-border theme-card shadow-lg px-4 py-3 sm:px-5">
        <span className="hidden sm:inline text-sm theme-text-muted">
